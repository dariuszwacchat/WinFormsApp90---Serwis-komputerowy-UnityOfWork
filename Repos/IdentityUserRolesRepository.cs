...
namespace WinFormsApp82.Repos
{
    public class IdentityUserRolesRepository : IIdentityUserRole
    {
        private readonly ApplicationDbContext _context;

        public IdentityUserRolesRepository (ApplicationDbContext context)
        {
            _context = context;
        }
